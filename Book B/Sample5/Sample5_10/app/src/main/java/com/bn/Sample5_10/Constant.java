...
{ 
	public static float WIDTH_SPAN=2f*63;//横向长度总跨度
	...
	public static  float waveFrequency1 = 0.19f;							//1号波波频
	public static float waveFrequency2 = 0.09f;								//2号波波频
	public static float waveFrequency3 = 0.01f;								//3号波波频
	
	
	public  static float waveAmplitude1=0.126f;							//1号波振幅
	public  static float waveAmplitude2=0.21f;							//2号波振幅
	public  static float waveAmplitude3=0.35f;							//3号波振幅
	...
	public static Object lock=new Object();//锁资源
}