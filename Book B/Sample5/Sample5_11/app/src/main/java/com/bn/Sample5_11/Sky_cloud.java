...
@SuppressLint("NewApi") public class Sky_cloud
{
	...
	{
		String mVertexShader=ShaderUtil.loadFromAssetsFile("vertex_fly.sh", mv.getResources());
		String mFragmentShader=ShaderUtil.loadFromAssetsFile("frag_fly.sh", mv.getResources());
