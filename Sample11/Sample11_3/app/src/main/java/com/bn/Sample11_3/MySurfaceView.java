...
public class MySurfaceView extends GLSurfaceView
{
	...
	public int initTexture(int drawableId)
	{
		...
		GLES30.glTexParameterf(GLES30.GL_TEXTURE_2D, GLES30.GL_TEXTURE_MIN_FILTER,GLES30.GL_NEAREST);//使用MipMap最近点纹理采样
		GLES30.glTexParameterf(GLES30.GL_TEXTURE_2D,GLES30.GL_TEXTURE_MAG_FILTER,GLES30.GL_LINEAR);//使用MipMap线性纹理采样
		//ST方向纹理拉伸方式
